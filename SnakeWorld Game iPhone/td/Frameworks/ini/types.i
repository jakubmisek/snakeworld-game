 ...
 * ----------------------------------------------------------------------------------------------------------------
 ********************************************************************************************************************/
size_t INI_LINKAGE ini_readString (ini_fd_t fd, char *str, size_t size)
{
    ini_t *ini = (ini_t *) fd;
 ...
 * ----------------------------------------------------------------------------------------------------------------
 ********************************************************************************************************************/
size_t INI_LINKAGE ini_writeString (ini_fd_t fd, const char *str)
{
    ini_t *ini = (ini_t *) fd;
    struct key_tag *_key;
 ...
 * ----------------------------------------------------------------------------------------------------------------
 ********************************************************************************************************************/
size_t INI_LINKAGE ini_readInt (ini_fd_t fd, int *value)
{
    ini_t *ini = (ini_t *) fd;
    int ret    = 0;
...
int INI_LINKAGE ini_readBool (ini_fd_t fd, int *value)
{
    ...
    default:
        if (!_stricmp (buffer, "true"))
            *value = 1;
        else if (!_stricmp (buffer, "false"))
            *value = 0;
        else if (!_stricmp (buffer, "on"))
            *value = 1;
        else if (!_stricmp (buffer, "off"))
            *value = 0;
        else if (!_stricmp (buffer, "yes"))
            *value = 1;

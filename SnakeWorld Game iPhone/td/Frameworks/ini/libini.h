...
INI_EXTERN size_t INI_LINKAGE ini_dataLength (ini_fd_t fd);
...
INI_EXTERN size_t INI_LINKAGE ini_readString  (ini_fd_t fd, char *str, size_t size);
INI_EXTERN size_t INI_LINKAGE ini_writeString (ini_fd_t fd, const char *str);
INI_EXTERN size_t INI_LINKAGE ini_readInt     (ini_fd_t fd, int *value);
    ...
    /* Extra Functions */
    INI_EXTERN size_t INI_LINKAGE ini_append      (ini_fd_t fddst, ini_fd_t fdsrc);
    ...
    INI_EXTERN size_t INI_LINKAGE ini_listLength      (ini_fd_t fd);
    /* Change delimiters, default "" */
    INI_EXTERN size_t INI_LINKAGE ini_listDelims      (ini_fd_t fd, const char *delims);

...
namespace SnakeWorld_Server
{
	...
	public partial class SnakeInfo : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _timeMinutesPlayed;
    ...
    partial void OntimeMinutesPlayedChanging(int value);
    partial void OntimeMinutesPlayedChanged();
    ...
    partial void OnmaxLengthChanged();
		...
		[Column(Storage="_timeMinutesPlayed", DbType="Int NOT NULL")]
		public int timeMinutesPlayed
		{
			get
			{
				return this._timeMinutesPlayed;
			}
			set
			{
				if ((this._timeMinutesPlayed != value))
				{
					this.OntimeMinutesPlayedChanging(value);
					this.SendPropertyChanging();
					this._timeMinutesPlayed = value;
					this.SendPropertyChanged("timeMinutesPlayed");
					this.OntimeMinutesPlayedChanged();
				}
			}
		}

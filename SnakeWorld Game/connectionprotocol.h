...
public:
	...
	void Send_Request(CBinaryWriter*pbw,wchar_t*name,wchar_t*email,wchar_t*password, wchar_t*desc, wchar_t*type, wchar_t*texture, unsigned int lng, wchar_t*worldname = 0);
